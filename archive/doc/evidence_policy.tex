...
% Thanks
\author{Angèle Delevoye\thanks{angele.delevoye@yale.edu}\vspace{-1ex}}
...
The policy and specific findings we will report on are yet to be determined. Ideally, we would use similar findings coming from 2 studies belonging to different tiers of evidence. The DoE has a comprehensive database of most studies conducted in education policy (What Works ClearingHouse), their findings and the evidence tier to which they belong. In order to identify the studies which belong in the dataset, the Institute of Education Sciences (IES) within the DoE conduct literature scans, receives public nominations or suggestions from education associations or other organizations, as well as input from state and federal policymakers. 

We can leverage this existing database, or similar ones constructed by other federal agencies (see \autoref{sec: clearinghouses} for a more comprehensive list of federal clearinghouses), in order to find studies we can use in our experiment. 
...
\subsection{Email wording} \label{sec: Email}
...
\begin{figure}[H]
\includegraphics[scale=0.65]{../figs/DoE_standards.png}
\bigbreak
\caption{DoE's tiers of evidence - implementation}
\label{fig: DoE_standards}
\end{figure}

\begin{figure}[H]
\includegraphics{../figs/DoE_missing.png}
\bigbreak
\caption{DoE's guidelines on missingness}
\label{fig: DoE_missing}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.65]{../figs/DoE_clusters.png}
\bigbreak
\caption{DoE's guidelines on clusters}
\label{fig: DoE_clusters}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.65]{../figs/DoE_RDs.png}
\bigbreak
\caption{DoE's guidelines on RDs}
\label{fig: DoE_RDs}
\end{figure}

\begin{figure}[H]
\includegraphics{../figs/DoE_CACE_IV.png}
\bigbreak
\caption{DoE's guidelines on IVs and CACE}
\label{fig: DoE_CACE_IV}
\end{figure}


\subsection{List of federal clearinghouses} \label{sec: clearinghouses}
