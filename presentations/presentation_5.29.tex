...
\textcolor{Cerulean}{366} unique intervention-outcome combinations. 

\textcolor{Cerulean}{6} unique intervention-outcome combinations with studies in all-three evidence tiers. 
\vspace{-8mm}
\captionsetup{labelformat=empty}
\input{../tables/all_tiers.tex}

\textcolor{Cerulean}{1} unique intervention-outcome combination with \textcolor{Cerulean}{significant} studies in all-three evidence tiers. 
\vspace{-8mm}
\input{../tables/all_tiers_sig.tex}
